module.exports = function (router) {
    ...
    router.get('/ningbo/cbbidding/pubinfo', require('./ningbo/cbbidding/pubinfo'));
    router.get('/ningbo/nbbidding/pubinfo', require('./ningbo/nbbidding/pubinfo'));
    router.get('/ningbo/nbyzprtc/pubinfo', require('./ningbo/nbyzprtc/pubinfo'));
